  ...
  return (
    <Box width="100%">
      <Text fontSize="14px" color="#333333" mb="2" display="flex">
        Number of employees{" "}
        <Text color="#8B8D97" fontSize="14px" ml="1">
          (Optional)
        </Text>
      </Text>
      <Flex gap={2}>
...
const TypeSelector = ({ selected, setSelected }) => {
  ...
  return (
    <Box width="100%">
      <Text fontSize="14px" color="#333333" mb="2">
        Type Select
      </Text>
  ...
  return (
    <Box backgroundColor="#F0F4F9" height={"100%"}>
      <HStack justifyContent="space-between" px="20px" alignItems="flex-start">
        ...
        <Box width="80%">
          <HeaderBar />
          <Box maxWidth="100%" p={4} bg="white" mt="1rem" padding="12px 20px">
            <Breadcrumb color="#8B8D97" mb={6}>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink
                  href="/distributors/AddDistributor"
                  color="#8B8D97"
                  fontSize="14px"
                >
              ...
              <Stack spacing={8} direction="column">
                <Stack spacing={8} direction={["column", "row"]}>
                  <FormControl isInvalid={Boolean(errors.companyName)}>
                    <FormLabel fontSize="14px" color="#333333">
                      Company Name
                    </FormLabel>
                    <Input
                      value={companyName}
                ...
                <HStack spacing={8} direction={["column", "row"]}>
                ...
                <HStack spacing={8} direction={["column", "row"]}>
                    ...
                    />
                    <FormControl isInvalid={Boolean(errors.dlNo)}>
                        <FormLabel fontSize="14px" color="#333333">
                        DL No
                        </FormLabel>
                        <Input
