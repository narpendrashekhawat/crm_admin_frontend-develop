          ...
          >
            ...
            <Box mb={0} ml={"1.1rem"}>
              ...
              <Text
                ...
                fontSize="sm"
              >
                Create and manage distributor / CNF details.
              </Text>
            </Box>
...
export default AddDistributorCnf;
    ...
    const delayDebounce = setTimeout(async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `${Config.search_dis}?search=${searchText}`, {
          headers: {
  ...
  const submitDistributor = async () => {
    try {
      ...
      const response = await axios.post(
        Config.add_distributor_by_user,
        payload,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("authToken")}`,
    ...
    <Box p={1}>
      ...
      <HStack mt={6}>
        ...
        <Button
          ...
          isLoading={loading}
        >
          Save {selectedType || "Distributor/CNF"}
        </Button>
      </HStack>
    </Box>
  );
