...
const ProfileItemsInfo = () => {
    ...
    useEffect(() => {
        const fetchManufacturerData = async () => {
            try {
                setLoading(true);
                const response = await axios.get(`${Config.ProfileItemsInfo_url}/${id}`, {
                    headers: {
    ...
    const prepareGeneralDetailsData = () => {
        ...
        return {
            ...
            drugLicense: manufacturer.drugLicense,
            fssaiLicense: manufacturer.fssaiLicense,
            wholesaleLicense: manufacturer.wholesaleLicense,
            totalProducts: manufacturerData.totalProducts,
            totalStocks: manufacturerData.totalStocks,
    ...
    const prepareAddressesData = () => {
        ...
        return [{
            businessAddress: manufacturerData.businessAddress,
            billingAddress: manufacturerData.billingAddress
        }];
    };
                ...
                <Box width='80%'>
                    ...
                    <Box p={4} bg="white" mt="1rem" padding="12px 20px" borderRadius="15px 15px 0px 0px">
                        <Breadcrumb color="#8B8D97" padding="10px 0px 2rem 0px">
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbLink href={`/manufacturers/profile/${id}`} color="#5570F1" fontSize="13px">Profile</BreadcrumbLink>
                            </BreadcrumbItem>
                        </Breadcrumb>
