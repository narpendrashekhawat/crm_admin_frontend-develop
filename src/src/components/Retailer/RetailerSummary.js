    ...
    const fetchRetailerStats = async () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setStatsData({
                    Retailer: {val:data?.retailerStats?.totalRetailer?.count || 0,per:data?.retailersStats?.totalRetailers?.percentageChange},
                    activeRetailer: {val: data?.retailerStats?.activeRetailer?.count || 0,per:data?.retailersStats?.totalRetailers?.percentageChange},
                    inactiveRetailer: {val: data?.retailerStats?.inactiveRetailer?.count || 0,per:data?.retailerStats?.totalRetailers?.percentageChange},
                    newRetailer: {val: data?.retailerStatsStats?.newProductsAdded || 0,per:data?.retailerStats?.totalRetailer?.percentageChange},
    ...
    return (
        ...
        <Box p={4} bg="white" mt='1rem' padding='12px 20px' borderRadius='15px 15px 0px 0px'>
            <Breadcrumb color="#8B8D97" padding='10px 0px 2rem 0px' >
                ...
                <BreadcrumbItem>
                    <BreadcrumbLink href='/manufacturers' color='#8B8D97' fontSize='13px'>Retailer List</BreadcrumbLink>
                </BreadcrumbItem>
            </Breadcrumb>
            ...
            <HStack justifyContent='space-between' gap="20px">
                ...
                <HStack>
                    <Button as={"a"} href="/AddRetailer" justifyContent={'space-between'} bg='#3E60AA' color='white' padding='0px 12px' fontWeight='400' borderRadius='12px' w='141px' h='36px' fontSize='14px'>
                ...
                <Box backgroundColor='#F0F4F9' padding='10px 15px' display='flex' flexDirection='column' gap='60px' flex={1} borderRadius='12px'>
                    ...
                    <HStack justifyContent='space-between' width='87%'>
                        <VStack gap='1px' alignItems='flex-start'>
                            ...
                            <HStack>
                                <Text color='#45464E' fontSize='20px' fontWeight='500' lineHeight='26px'>1,250</Text>
                                <Text color='#45464E' fontSize='12px' fontWeight='500' lineHeight='26px' textColor={"#519C66"}>+15.80%</Text>
                            </HStack>
                        </VStack>
                        ...
                        <VStack gap='1px' alignItems='flex-start'>
                            ...
                            <HStack>
                                <Text color='#45464E' fontSize='20px' fontWeight='500' lineHeight='26px'>1,180</Text>
                                <Text color='#45464E' fontSize='12px' fontWeight='500' lineHeight='26px' textColor={"#519C66"}>+85%</Text>
                            </HStack>
                        </VStack>
                        <VStack gap='1px' alignItems='flex-start'>
                            <Text color='#8B8D97' fontSize='14px'>In-Active</Text>
                            <HStack>
                                <Text color='#45464E' fontSize='20px' fontWeight='500' lineHeight='26px'>70</Text>
                                <Text color='#45464E' fontSize='12px' fontWeight='500' lineHeight='26px' textColor={"#CC5F5F"}>-10%</Text>
                            </HStack>
                        </VStack>
                    </HStack>
                </Box>
